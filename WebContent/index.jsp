      ...
      <div class="intro">
        ...
        <div class="intro-text left-0 text-center bg-faded p-5 rounded">
          <h2 class="section-heading mb-4">
            ...
            <span class="section-heading-lower">Tierra Media</span>
          </h2>
          <p class="mb-3">Realice una visita por estas magicas tierras y no querra irse...
            Disfrute de maravillosos paisajes, divertidas aventuras y deliciosos platillos.
          </p>
          <div class="intro-button mx-auto">
            <a class="btn btn-primary btn-xl" href="usuarios.jsp">Iniciar Sesión</a>
          </div>
        </div>
      </div>
    </div>
